...
AddEventHandler("esx_animations:ClientEmoteRequestReceive", function(emotename, nammmee)
    isRequestAnim = true
    requestedemote = emotename

    --SimpleNotify(Config.Languages[lang]['doyouwanna']..remote.."~w~)")
    ESX.ShowNotification('<font color=orange>طلب تمثيل حركة</font></br>'..nammmee..'</br><font color=yellow>للموافقة اضغط Y')
