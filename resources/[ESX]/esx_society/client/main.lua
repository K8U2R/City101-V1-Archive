ESX = nil
local show_water_mark_society = false
...
function RefreshBussHUD()
	show_water_mark_society = false
	if ESX.PlayerData.job.grade_name == 'boss' or ESX.PlayerData.job.grade_name == 'bosstwo' or ESX.PlayerData.job.grade_name == 'high_admin' then
		ESX.TriggerServerCallback('esx_society:getSocietyMoney', function(money)
			ShowWatrMarkMoneySociety(money)
...
function ShowWatrMarkMoneySociety(money)
end

RegisterNetEvent('esx_addonaccount:setMoney')
AddEventHandler('esx_addonaccount:setMoney', function(society, money)
	show_water_mark_society = false
	if ESX.PlayerData.job and (ESX.PlayerData.job.grade_name == 'boss' or ESX.PlayerData.job.grade_name == 'bosstwo' or ESX.PlayerData.job.grade_name == 'high_admin')  and 'society_' .. ESX.PlayerData.job.name == society then
		ShowWatrMarkMoneySociety(money)
	end
end)
		...
		if data.current.value == 'withdraw_society_money' then
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'withdraw_society_money_amount_' .. society, {
				...
				if amount == nil then
					...
					menu.close()
					print(society)
					TriggerServerEvent('esx_K2sociabdurhmanety:withdrawMoney', society, amount)
				end
		...
		elseif data.current.value == 'deposit_money' then
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'deposit_money_amount_' .. society, {
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('esx_K2sociabdurhmanety:depositMoney', society, amount)
				end
		...
		elseif data.current.value == 'wash_money' then
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'wash_money_amount_' .. society, {
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('esx_K2sociabdurhmanety:washMoney', society, amount)
				end
	...
	ESX.TriggerServerCallback('esx_society:getEmployees', function(employees)
		...
		ESX.UI.Menu.Open('list', GetCurrentResourceName(), 'employee_list_' .. society, elements, function(data, menu)
			...
			elseif data.value == 'fire' then
				...
				ESX.TriggerServerCallback('esx_sK222ociabdurhmanety:setJob', function()
					OpenEmployeeList(society)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_grades_' .. society, {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'manage_grades_amount_' .. society, {
				...
				elseif amount > Config.MaxSalary then
					...
					ESX.TriggerServerCallback('esx_socKDKDKDDieABDURHMANty:setJobSalary', function()
						OpenManageGradesMenu(society)
