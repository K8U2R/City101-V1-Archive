...
function StopDriveTest(success)
	if success then
		...
		ESX.ShowNotification(_U('passed_test'))
		TriggerServerEvent('esx_dmvschool:ADI', last_get_player)
	else
		ESX.ShowNotification(_U('failed_test'))
	end
...
Citizen.CreateThread(function()
	...
	AddTextComponentString("<FONT FACE='A9eelsh'> ﺓﺩﺎﻴﻘﻟﺍ ﺔﺳﺭﺪﻣ </font>")
