...
RegisterNetEvent('esx_dmvschool:ADI')
AddEventHandler('esx_dmvschool:ADI', function(last_get_player_to)
	local xPlayer = ESX.GetPlayerFromId(source)
	if xPlayer then
		TriggerClientEvent('esx_adminjob:addHaveIIL', xPlayer.source, last_get_player_to)
	end
end)
