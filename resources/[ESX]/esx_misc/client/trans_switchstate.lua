...
local timer = 0
local vehicle = nil
RegisterNetEvent("esx_misc:JoinTransistion_switchstate:start")
AddEventHandler("esx_misc:JoinTransistion_switchstate:start", function(po)
	...
	disableAllControlActions = true	-- disable all control
					Citizen.CreateThread(function()
				  while disableAllControlActions do
					  Citizen.Wait(0)
					  DisableAllControlActions(0)
				  end
			  end) -- disable all control END
