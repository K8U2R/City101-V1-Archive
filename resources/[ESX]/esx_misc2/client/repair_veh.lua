...
AddEventHandler('esx_misc2:Start_repair', function(ped, coords, veh)
	...
	--exports['progressBars']:startUI(9250, "جاري التصليح") -- TRANSLATE THIS, THAT SAY WHEN YOU PUT THE CRIC
	...
	--exports['progressBars']:startUI(11000, "جاري التصليح") -- TRANSLATE THIS - THAT SAY WHEN YOU REPAIR THE VEHICLE
	...
	--exports['progressBars']:startUI(8250, "جاري التصليح") -- TLANSTALE THIS - THAT SAY WHEN YOU LEAVE THE CRIC
