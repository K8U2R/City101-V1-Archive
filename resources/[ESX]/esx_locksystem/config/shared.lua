...
local Keys = {
	["."] = 81, ["ESC"] = 322, ["F1"] = 288, ["F2"] = 289, ["F3"] = 170, ["F5"] = 166, ["F6"] = 167, ["F7"] = 168, ["F8"] = 169, ["F9"] = 56, ["F10"] = 57,
...
Config = {
	...
	key = Keys['E'],				-- e.g : Keys["H"] will be change the U key to the H key for lock/unlock a vehicle
