		...
		if not lastPlayerSuccess[source] or timeNow - lastPlayerSuccess[source] > 5 then
			...
			TriggerEvent('esx_addonaccount:getSharedAccount', 'society_taxi', function(account)
                ...
                TriggerClientEvent('pNotify:SendNotification',source, {
					text = "<font size=5><center><b>انت كسبت: <font size=5 color=00EE4F>$<font color=white>" .. playerMoney.."<br /><br /><font size=5 color=gray><center><b>نسبة الشركة: <font size=5 color=FFAE00>$<font color=white>" .. societyMoney,
					type = "alert",
					queue = left,
					timeout = 1000,
					killer = false,
                ...
                TriggerClientEvent('pNotify:SendNotification',source, {
					text = "<font size=5><center><b>انت كسبت: <font size=5 color=00EE4F>$<font color=white>" .. total,
					type = "alert",
					queue = left,
					timeout = 1000,
					killer = false,
