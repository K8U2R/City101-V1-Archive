...
AddEventHandler('esx_agentjob:OpenVehicleSpawnerMenu2', function(type, station, part, partNum)
...
function StoreNearbyVehicle(playerCoords)
	...
	ESX.TriggerServerCallback('esx_agentjob:storeNearbyVehicle', function(storeSuccess, foundNum)
...
function GetAvailableVehicleSpawnPoint2(station, part, partNum)
	local spawnPoints = Config.AgentStations[station]["Vehicles"][partNum].SpawnPoints2
...
function GetAvailableVehicleSpawnPoint(station, part, partNum)
	local spawnPoints = Config.AgentStations[station][part][partNum].SpawnPoints
	local found, foundSpawnPoint = false, nil
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm', {
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('esx_agentjob:buyJobVehicle', function (bought)
					if bought then
