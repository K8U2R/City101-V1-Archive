...
local toggle_helicam = 183 -- control id of the button by which to toggle the helicam mode. Default: INPUT_CONTEXT (E)
...
local toggle_spotlight = 51 -- control id to toggle the front spotlight Default: INPUT_PhoneCameraGrid (G)
...
local vision_state = 2 -- 0 is normal, 1 is nightmode, 2 is thermal vision
