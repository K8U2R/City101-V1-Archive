...
UTK.hacktime = 15000 -- first door open delay to make time for police to arrive and roleplay in miliseconds (I highly recommend to leave it be (2.5 min default))
UTK.maxcash = 1300 -- maximum amount of cash a pile can hold
UTK.mincash = 500 -- minimum amount of cash a pile holds
UTK.black = true -- enable this if you want blackmoney as a reward
UTK.cooldown = 1800 -- amount of time to do the heist again in seconds (15min)
UTK.mincops = 1--3 -- minimum required cops to start mission
