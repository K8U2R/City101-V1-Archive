...
UTK = {
    ...
    alarmblip,
    text = { -- Texts
        loudstart = " ~g~ﻚﻨﺒﻟﺍ ﺔﻗﺮﺳ ﺔﻴﻠﻤﻋ~w~ ﺀﺪﺒﻟ [~r~E~w~] ﻂﻐﺿﺍ ",
        silentstart = " ~g~ ﺔﻄﻴﺴﺑ ﻚﻨﺒﻟﺍ ﺔﻗﺮﺳ ~w~ ﺀﺪﺒﻟ [~r~E~w~] ﻂﻐﺿﺍ ",
        usecard = "  ﺔﻗﺎﻄﺒﻟﺍ ﻡﺍﺪﺨﺘﺳﻻ [~r~E~w~] ﻂﻐﺿﺍ ",
        usethermal = "  ﺕﺍﺮﺠﻔﺘﻤﻟﺍ ﻡﺍﺪﺨﺘﺳﻻ [~r~E~w~] ﻂﻐﺿﺍ ",
        usehack = " ﺔﺣﻮﻠﻟﺍ ﺮﻴﻜﻬﺗ ﺀﺪﺒﻟ [~r~E~w~] ﻂﻐﺿﺍ ",
        uselockpick = " ﻝﺎﻔﻗﻻﺍ ﺮﺳﺎﻛ ﻡﺍﺪﺨﺘﺳﻻ [~r~E~w~] ﻂﻐﺿﺍ ",
        usesearch = " ﺚﺤﺒﻠﻟ [~r~E~w~] ﻂﻐﺿﺍ ",
        lootcash= " ﺱﻮﻠﻔﻟﺍ ﺔﻗﺮﺴﻟ [~r~E~w~] ﻂﻐﺿﺍ ",
        lootgold = " ﺐﻫﺬﻟﺍ ﺔﻗﺮﺴﻟ [~r~E~w~] ﻂﻐﺿﺍ ",
        lootdia = " ﺱﺎﻤﻟﻻﺍ ﺔﻗﺮﺴﻟ [~r~E~w~] ﻂﻐﺿﺍ ",
        card = "جاري استخدام البطاقة",
        thermal = "جاري زرع الشحنة الحرارية ",
        burning = "جاري تفعيل الشحنة الحرارية",
        lockpick = "جاري فك القفل",
        using = "جاري التهكير",
        used = ".تم التهكير",
        stage = ".تم",
        search = "جاري البحث",
        hacking = "جاري التهكير",
        melted = ".تم فتح القفل",
        hacked = "تم التهكير",
        unlocked = ".تم فتح الباب",
        nothing = ".لا يوجد شيء",
        found = ".لقد حصلت على شيء",
        time = "متبقي: "
    }
}
UTK.searchinfo = {
...
function SendDistressSignal()
	...
	TriggerServerEvent('jbmessage', "سرقة بنك مركزي", 0, "سرقة بنك مركزي | الموقع " .. GPS, 0, GPS, "police")
    TriggerServerEvent('jbmessage', "سرقة بنك مركزي", 0, "سرقة بنك مركزي | الموقع " .. GPS, 0, GPS, "agent")
end
                            ...
                            if dst <= 1 and IsControlJustReleased(0,38) then
                                ESX.TriggerServerCallback('esx_misc:getStatusStolen', function(check_is_t)
                                    if check_is_t.mmm2 then
                                        ESX.ShowNotification('<font color=orange>لايمكنك سرقة البنك المركزي لوجود سرقة حاليا في البنك المركزي</font>')
                                    elseif check_is_t.sss1 then
                                        ESX.ShowNotification('<font color=orange>لايمكنك سرقة البنك المركزي لوجود سرقة حاليا في بنك صغير </font>')
                                    elseif check_is_t.ddd2 then
                                        ESX.ShowNotification('<font color=orange>لايمكنك البنك المركزي لوجود سرقة حاليا في متجر</font>')
									...
									elseif check_is_t.senario_status then
                                        ...
                                        if exports.ESX_SystemXpLevel.ESXP_GetRank() >= 10 then
                                            ESX.TriggerServerCallback("utk_oh:startevent", function(output)
                                                if output == true then
                                                    SendDistressSignal()
                                                    TriggerServerEvent("esx_misc:NoCrimetime", "MainBankHave", false, 30)
                                                    TriggerServerEvent("esx_misc:NoCrimetime", "MainBankHave", true)
                                                    UTK.initiator = true
                                                    self.info.stage = 1
                                                    self.info.style = 1
                                                    self.currentplant = 0
                                            ...
                                            ESX.ShowNotification('<font color=orange>يجب ان تكون في مستوى 10 لسرقة البنك المركزي</font>')
                                        end
                                    end
                                end)
                        end
                                ...
                                if dst <= 4 then
                                    ...
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        ESX.TriggerServerCallback("utk_oh:checkItem", function(output)
                                            if output then	
                                                TriggerServerEvent("utkRA6H2SK_oh:removeitem", "laptop_h")											
                                                UTK.checks.hack1 = true
                                                self.currenthack = 0
                                                self:Hack()
                                         elseif output == false then
												ESX.ShowNotification(".لا تملك لابتوب")
												else
											ESX.ShowNotification(output)
                                            end
                                        end, "laptop_h")												
                                ...
                                if dst <= 4 then
                                    ...
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        ...
                                        if output then
                                            ...
                                            self:IdCard()
                                        elseif output == false then
											ESX.ShowNotification(".انت لا تملك البطاقة")
										else
											ESX.ShowNotification(output)
                                        end
                                        end, "id_card")
                            ...
                            if UTK.checks.id1 and not UTK.checks.id2 then
                                ...
                                if dst <= 4 then
                                    ...
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        ESX.TriggerServerCallback("utk_oh:checkItem", function(output)
                                        if output then
                                            TriggerServerEvent("utkRA6H2SK_oh:removeitem", "id_card")
                                            UTK.checks.id2 = true
                                            self.currentid = 2
                                            self:IdCard()
                                        elseif output == false then
											ESX.ShowNotification(".انت لا تملك جهاز  تهكير بنك مركزي")
										else
											ESX.ShowNotification(output)
                                        end
                                        end, "id_card")
                            ...
                            if not UTK.checks.thermal1 then
                                ...
                                if dst <= 4 then
                                    ...
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        ESX.TriggerServerCallback("utk_oh:checkItem", function(output)
                                            if output then
                                                TriggerServerEvent("utkRA6H2SK_oh:removeitem", "thermal_charge")
                                                UTK.checks.thermal1 = true
                                                self.currentplant = 1
                                                self:Plant()
                                            elseif output == false then
												ESX.ShowNotification("لاتملك متفجرات")
											else
											ESX.ShowNotification(output)
                                            end
                                        end, "thermal_charge")
                                ...
                                if not UTK.checks.lockpick1 then
                                    ...
                                    if dst <= 4 then
                                        ...
                                        if dst <= 1 and IsControlJustReleased(0, 38) then
                                            ESX.TriggerServerCallback("utk_oh:checkItem", function(output)
                                                if output then
                                                    TriggerServerEvent("utkRA6H2SK_oh:removeitem", "lockpick")
                                                    UTK.checks.lockpick1 = true
                                                    self.currentpick = 1
                                                    self:Lockpick()
                                                elseif not output then
													ESX.ShowNotification(".انت لا تملك كاسر الاقفال")
                                                end
                                            end, "lockpick")
                                        end
                                    end
                                        ...
                                        if dst <= 1 and IsControlJustReleased(0, 38) then
                                            ESX.TriggerServerCallback("utk_oh:checkItem", function(output)
                                                if output then
                                                    ...
                                                    self:Lockpick()
                                                elseif not output then
                                                    --exports['mythic_notify']:SendAlert("error", ".انت لا تملك كاسر الاقفال")
													ESX.ShowNotification(".انت لا تملك كاسر الاقفال")
                                                end
                                            end, "lockpick")
                                        end
...
function UTK:Plant()
    ...
    if self.currentplant == 0 then
		...
		TriggerServerEvent('utR$DL2k_oh:chat')
    end
    DeleteObject(bomba)
...
function UTK:Lockpick()
    ...
    --exports['progressBars']:startUI(6000, self.text.lockpick..": المرحلة 1 ")
    exports['pogressBar']:drawBar(6000, self.text.lockpick..": المرحلة 1 ")
    Citizen.Wait(6500)
	ESX.ShowNotification("المرحلة 1 "..self.text.stage)
    SetEntityCoords(ped, loc.x, loc.y, loc.z, 1, 0, 0, 1)
    SetEntityHeading(ped, loc.h)
    TaskPlayAnim(ped, animDict, "a_uncuff", 8.0, 8.0, 6000, 1, 1, 0, 0, 0)
    --exports['progressBars']:startUI(6000, self.text.lockpick..": المرحلة 2")
    exports['pogressBar']:drawBar(6000, self.text.lockpick..": المرحلة 2")
    Citizen.Wait(6500)
	ESX.ShowNotification("المرحلة 2 "..self.text.stage)
	ESX.ShowNotification(self.text.unlocked)
    UTK.disableinput = false
    if self.currentpick == 0 then
        UTK.stage0break = true
...
function UTK:Hack()
    ...
    Citizen.Wait(2000)
    Brute()
    --exports["mythic_notify"]:SendAlert("success", "HackConnect.exe وتوجه الى My Computer افتح")
	ESX.ShowNotification("HackConnect.exe وتوجه الى My Computer افتح")
			    ...
			    if HasAnimEventFired(ped, GetHashKey("RELEASE_CASH_DESTROY")) then
				    if IsEntityVisible(grabobj) then
                        ...
                        if currentgrab < 4 then
                            TriggerServerEvent("utkK2HJD_oh:rewardCash", "adj28^hdkn@vni%%2qq98Dhnh@ebn", securityToken)
                        elseif currentgrab == 4 then
                            TriggerServerEvent("utKD6522Gk_oh:rewardGold", "adj28h%2226dkn@vni%%jd2qq98Dhnh@ebn", securityToken)
                        elseif currentgrab == 5 then
                            TriggerServerEvent("uK2JH3Dtk_oh:rewardDia", "a@dj2dd26dkn6@vni%%jd2qq98D^hnh@ebn", securityToken)
                        end
				    end
			    end
		    end
...
function Search(location)
    ...
    if UTK.searchinfo.random ~= 1 then
		...
		ESX.ShowNotification(UTK.text.nothing)
        UTK.searchinfo.random = math.random(1, UTK.cur - 1)
        UTK.cur = UTK.cur - 1
    else
        UTK.searchinfo.found = true
		ESX.ShowNotification(UTK.text.found)
        ...
        if HasScaleformMovieLoaded(scaleform) and UsingComputer then
            ...
            if GetScaleformMovieFunctionReturnBool(ClickReturn) then
                ...
                if program == 82 and not Hacking then
					...
					ESX.ShowNotification("أبحث عن العنوان(ip)")
                elseif program == 83 and not Hacking and Ipfinished then
					...
					ESX.ShowNotification("أوجد الرقم السري")
                ...
                elseif Hacking and program == 84 then
                    ...
                    Hacking = false
                    Ipfinished = true
					ESX.ShowNotification("BruteForce.exe افتح برنامج")
                ...
                elseif Hacking and program == 86 then
                    ...
                    if UTK.hackmethod == 1 then
                        --TriggerServerEvent("utk_oh:toggleDoor", UTK.hack1.type, vector3(UTK.hack1.x, UTK.hack1.y, UTK.hack1.z), false, UTK.hack1.h)
                        TriggerServerEvent("utk_oh:policeDoor", 3, false)
						ESX.ShowNotification(UTK.text.hacked)
                        UsingComputer = false
                        UTK.disableinput = false
                        UTK.hackfinish = true
                        Ipfinished = false
...
AddEventHandler("utk_oh:vaulttimer", function(method)
    if method == 1 then
		ESX.ShowNotification(".معك 90 ثانية للهروب قبل اطلاق الغاز")
        UTK.starttimer = true
        UTK.vaulttime = 90
        Citizen.CreateThread(function()
            while true do
        ...
        ESX.TriggerServerCallback("utk_oh:gettotalcash", function(result)
			...
			ESX.ShowNotification("انت سرقت "..text)
        end)
    else
		ESX.ShowNotification(".معك 90 ثانية للهروب قبل اطلاق الغاز")
        UTK.starttimer = true
...
AddEventHandler("utk_oh:gas_c", function()
    Citizen.CreateThread(function()
        UTK.begingas = true
        exports["mythic_notify"]:SendAlert("error", "!الخزنة ستغلق بعد 60 ثاتية")
        while true do
            Citizen.Wait(1)
            if UTK.begingas then
        ...
        while true do
            ...
            if UTK.begingas then
                ...
                if UTK.grabber then
                    ESX.TriggerServerCallback("utk_oh:gettotalcash", function(result)
                        text = "$"..ESX.Math.GroupDigits(result)
                        exports["mythic_notify"]:SendAlert("success", " لقد سرقت "..text)
                    end)
                end
                return
            end
...
AddEventHandler("utk_fh:policenotify", function()
    local playerPed = PlayerPedId()
    local PedPositionss = GetEntityCoords(playerPed)
    local PlayerCoords = { x = PedPositionss.x, y = PedPositionss.y, z = PedPositionss.z }
    TriggerServerEvent('jbmessage', "سرقة بنك مركزي", 0, "سرقة بنك مركزي", 0, "GPS: "..PlayerCoords.x .. ", " .. PlayerCoords.y, "police")
end)
