function GenerateReport(evidence) {
    ...
    html_header += "<div id=\"header_title\">" + 'الدليل بعد المراجعة و التدقيق' + "</div>";
    html_header += "<div id=\"header_seal\"></div>";
    html_header += "<div id=\"header_details\"><h2>" + 'دليل جنائي من إدارة الشرطة!' + "</h2>";
    ...
    for (i = 0; i < Object.keys(evidence).length; i++) {
        ...
        html_middle += "<div id=\"section_footer_block\">" + 'دليل #' + ' (' + evidence[i]["type"] + ')' + (i + 1) + "</div>";
