...
RegisterNetEvent("send:discordLogs:noinfo")
AddEventHandler("send:discordLogs:noinfo", function(message, color, channel)
    discordLog(message, joinColor, channel)
end)

RegisterNetEvent("send:discordLogs")
AddEventHandler("send:discordLogs", function(id, message, color, channel)
    ...
    discordLog(_message, joinColor, channel)
end)
