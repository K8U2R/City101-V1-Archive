...
Config.Voice = "mumble" -- mumble, saltychat, pma
...
Config.WaterMarkText1 = "101" -- Top right server text
Config.WaterMarkText2 = "City"  -- Top right server text
Config.WaterMarkLogo = "https://l.top4top.io/p_3025orsal1.png" -- Logo url
Config.LogoWidth = "5.5rem"
Config.LogoHeight = "5.0rem"
...
Config.SettingsLocale = { -- Settings texts
    ...
    ["text_hud_1"] = "ارقام",
    ["text_hud_2"] = "1",
    ["classic_hud_1"] = "الكلاسيكي",
    ["classic_hud_2"] = "2",
    ["radial_hud_1"] = "كلاسيكي مدور",
    ["radial_hud_2"] = "3",
    ["hide_hud"] = "اخفاء الهود",
    ["health"] = "Vita",
    ["armor"] = "Armatura",
    ["thirst"] = "Sete",
    ["stress"] = "Stress",
    ["oxy"] = "Ossigeno",
    ["hunger"] = "Fame",
    ["show_hud"] = "تشغيل الهود",
    ["stamina"] = "Stamina",
    ["nitro"] = "Nitro",
    ["Altitude"] = "Altitudine",
    ["Parachute"] = "Paracadute",
    ["enable_cinematicmode"] = "تفعيل وضع السينما",
    ["disable_cinematicmode"] = "ايقاف وضع السينما",
    ["exit_settings_1"] = "ESCI",
    ["exit_settings_2"] = "IMPOSTAZIONI",
    ["speedometer"] = "SPEEDOMETER",
    ["map"] = "شكل الخريطة",
    ["show_compass"] = "إظهار الوقت / التاريخ",
    ["hide_compass"] = "إخفاء الوقت / التاريخ",
    ["rectangle"] = "مربع",
    ["radial"] = "مدور",
    ["dynamic"] = "DYNAMiC",
    ["status"] = "STATUS",
    ...
    ["enable_edit_mode"] = "نقل الهود حبة",
    ["enable_edit_mode_2"] = "نقل الهود مجموعة",
    ["change_status_size"] = "تغيير حجم الهود",
    ["change_color"] = "تغيير لون الهود",
    ["disable_edit_mode"] = "تعديل وضع التعديل",
    ["reset_hud_positions"] = "اعادة تعيين الهود",
    ["info_text"] = "ضع في اعتبارك أن زيادة معدل التحديث يمكن أن تقلل من أداء اللعبة!",
    ["speedometer_size"] = "حجم عداد السرعة",
    ["refresh_rate"] = "معدل التحديث",
    ["esc_to_exit"] = "اضغط على ESC للخروج من وضع التعديل",
