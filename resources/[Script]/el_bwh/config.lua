Config = {
    ...
    admin_groups = {"superadmin"}, -- groups that can use admin commands all
    admin2_groups = {"a","aplus","mod","modplus","admin","superadmin"}, -- ban
    ...
    assist_keys = {enable=false,accept=208,decline=207}, -- keys for accepting/declining assist messages (default = page up, page down) - https://docs.fivem.net/game-references/controls/
    ...
    kick_without_steam = false, -- prevent a player from joining your server without a steam identifier.
