...
AddEventHandler('esx:setJob', function(job)
	TriggerServerEvent('esx_wesam:setNameInRadioAfterChangeJobPlayer')
end)

RegisterNetEvent('esx_radiolist:Client:ChangeNameInRadio2')
AddEventHandler('esx_radiolist:Client:ChangeNameInRadio2', function(name_player)
	ExecuteCommand('nameinradio ' .. name_player)
end)

RegisterNetEvent('esx_radiolist:Client:ChangeNameInRadio')
AddEventHandler('esx_radiolist:Client:ChangeNameInRadio', function(grade_label_job, name_player)
	ExecuteCommand('nameinradio ' .. "ID : " .. GetPlayerServerId(PlayerId()) .. " | " .. name_player .. " | " .. grade_label_job)
end)
RegisterNetEvent('esx_radiolist:Client:SyncRadioChannelPlayers')
AddEventHandler('esx_radiolist:Client:SyncRadioChannelPlayers', function(src, RadioChannelToJoin, PlayersInRadioChannel)
...
RegisterNetEvent('esx_radiolist:Client:DisconnectPlayerCurrentChannel')
AddEventHandler('esx_radiolist:Client:DisconnectPlayerCurrentChannel', function()
	ResetTheRadioList() -- Delete the PlayersInRadio contents so it opens up memory
	HideTheRadioList()
end)
