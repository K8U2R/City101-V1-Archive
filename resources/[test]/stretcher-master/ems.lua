...
Citizen.CreateThread(function()
	while true do 
		Citizen.Wait(5000)
		TriggerEvent("ARPF-EMS:stretcherSync", -1,str)	
	end
end)
...
TriggerEvent('chat:removeSuggestion', '/spawnstr_kal;da38ydg,b3ydadu;ad;a;;3t7')
TriggerEvent('chat:removeSuggestion', '/pushstr_lakdak39alnda;#&hda;n')
TriggerEvent('chat:removeSuggestion', '/openbaydoors_lka;la387g6g@;a38')
TriggerEvent('chat:removeSuggestion', '/togglestr_;adja38dgy:a;oh')
TriggerEvent('chat:removeSuggestion', '/stretcherSync')

--[[]]
RegisterCommand('spawnstr_kal;da38ydg,b3ydadu;ad;a;;3t7', function()
...
AddEventHandler("ARPF-EMS:getintostretcher", function()
    ...
    if DoesEntityExist(closestObject) then
        local strCoords = GetEntityCoords(closestObject)
        local strVecForward = GetEntityForwardVector(closestObject)
        local sitCoords = (strCoords + strVecForward - 180.0)
        local pickupCoords = (strCoords + strVecForward + 0.5)
