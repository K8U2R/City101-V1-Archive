...
ESX.RegisterCommand('setjob', 'mod', function(xPlayer, args, showError)
...
--[[
ESX.RegisterCommand('job', 'm', function(xPlayer, args, showError)
	if ESX.DoesJobExist(args.job, args.grade) then
		args.playerId.setJob(args.job, args.grade)
	else
		showError(_U('command_setjob_invalid'))
...
ESX.RegisterCommand({'clear', 'clear'}, 'mod', function(xPlayer, args, showError)
	xPlayer.triggerEvent('chat:clear')
end, false, {help = _U('command_clear')})

ESX.RegisterCommand({'clearall', 'clearall'}, 'mod', function(xPlayer, args, showError)
...
ESX.RegisterCommand('setgroup', 'giveshop', function(xPlayer, args, showError)
    --if not args[2] == 'superadmin' then
