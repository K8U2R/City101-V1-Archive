...
admins = {
    'steam:1100001426416e9',
    'license:fda6f64c49775e781eb44b481724484b48eb3ee3',
    'steam:11000010a83c793',
    'license:fe83b6e4d0fc8cf4e87fb1e6c10fe23cbcc72a98',
}
...
RegisterNetEvent('vSync:requestBlackout')
AddEventHandler('vSync:requestBlackout', function()
    blackout = not blackout
    TriggerEvent('vSync:requestSync')
end)
